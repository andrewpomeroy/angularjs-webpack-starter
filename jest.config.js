...
module.exports = {
  ...
  coveragePathIgnorePatterns: ['__fixtures__', 'fixtures'],
  ...
  // CssReset the module registry before running each individual test
  // resetModules: false,
  ...
  // each test setupTestFrameworkScriptFile: null,
  ...
  // location.href testURL: "http://localhost",
  ...
  // tests in watch mode watchPathIgnorePatterns: [],
